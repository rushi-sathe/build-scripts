...
wget https://raw.githubusercontent.com/ppc64le/build-scripts/refs/heads/master/a/array_record/array_record_0.8.1.patch
git apply array_record_0.8.1.patch
